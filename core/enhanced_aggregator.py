...
class EnhancedAggregator:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        """
        # 在实例化时从模块动态获取 ``MemoryManager``，确保
        # ``patch('memory.memory_manager.MemoryManager')`` 在测试中能够生效。
        memory_manager_module = importlib.import_module("memory.memory_manager")
    ...
    def provide_feedback(self, query: str, response: str, feedback: Dict[str, Any]):
        ...
        self.memory_manager.store_memory("feedback", feedback_data)
