...
class TestEnhancedRouter(unittest.TestCase):
    ...
    def test_route_query(self):
        ...
        # 当默认策略本身是已注册的高级策略（此处配置 default_strategy="semantic"）时，
        # 它优先于 agent_strategy_mapping —— 与集成测试 test_routing_integration 中
        # execute_route 报告高级策略名称的行为保持一致。
        self.assertEqual(route_info["strategy"], "semantic")
